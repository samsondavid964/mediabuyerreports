    ...
    return (
        <div className="glass-card p-6 animate-fade-in-up" style={{ animationDelay: '300ms' }}>
            ...
            <div className="flex flex-col gap-3 max-h-[340px] overflow-y-auto pr-1">
                {recent.length === 0 ? (
                    <div style={{ color: '#64748b' }} className="text-sm py-8 text-center">No recent activity</div>
                ) : (
                    recent.map((log, i) => (
                        <div
                            key={log.id}
                        ...
                        >
                            <div className="flex items-center justify-between gap-2 flex-wrap">
                                <span className="font-semibold text-sm rounded-lg px-2 py-0.5" style={{ background: 'rgba(0,229,204,0.08)', color: '#00e5cc', fontFamily: 'Syne, sans-serif' }}>
                                    {log.client_name}
                                </span>
