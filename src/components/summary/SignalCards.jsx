    ...
    return (
        ...
        >
            <div className="flex items-center justify-between mb-2">
                ...
                <div className="text-base font-bold" style={{ color: accentColor, fontFamily: 'Syne, sans-serif' }}>
                    {percentage}%
                </div>
            </div>
            ...
            <div className="flex flex-col mt-auto">
                ...
                <span className="text-base tracking-wide font-medium" style={{ color: 'var(--text-muted)' }}>
                    {signalType}
                </span>
            </div>
        </div>
